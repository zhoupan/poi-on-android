...
/**
 * An activity representing a single Document detail screen. This activity is only used on handset
 * devices. On tablet-size devices, item details are presented side-by-side with a list of items in
 * a {@link DocumentListActivity}.
 *
 * <p>This activity is mostly just a 'shell' activity containing nothing more than a {@link
...
public class DocumentDetailActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      arguments.putString(
          DocumentDetailFragment.ARG_ITEM_ID,
