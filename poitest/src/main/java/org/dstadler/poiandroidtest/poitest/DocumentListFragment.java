...
/**
 * A list fragment representing a list of Documents. This fragment also supports tablet devices by
 * allowing list items to be given an 'activated' state upon selection. This helps indicate which
 * item is currently being viewed in a {@link DocumentDetailFragment}.
 *
